    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-poste">
              ...
              <a href="#"  data-toggle="modal" data-target="#modal-xl" class="float-right" style="color: #f4cc3a; font-weight:bold"><i class="fas fa-plus"></i> Ajouter un bureau</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>312046</td>
                  <td>
                    <a class="btn btn-info"><i class="fa fa-pen"></i></a>
