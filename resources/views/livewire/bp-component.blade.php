...
<div wire:igonre.self class="modal fade" id="modalbp">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="code_postale"
                                                placeholder="Enter code postale">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="code_comptable"
                                                placeholder="Entrer code comptable">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ccp_bureau"
                                                placeholder="Enter ccp de bureau">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
